...
<style scoped>
.register-page{max-width:900px;margin:0 auto;padding:56px 24px}.register-card{padding:42px;background:white;border:1px solid #e6edf0;border-radius:26px;box-shadow:0 20px 50px rgba(35,62,73,.08)}.register-heading{margin-bottom:30px}.register-heading span{color:#b17616;font-size:12px;font-weight:750;letter-spacing:.14em}.register-heading h1{margin:10px 0;color:#1d3d4b;font-size:34px;font-weight:780}.register-heading p{margin:0;color:#74838c}.form-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:0 20px}.submit-button{width:100%;height:48px;background:#0f7089;border-color:#0f7089;font-weight:700}@media(max-width:650px){.register-card{padding:26px}.form-grid{grid-template-columns:1fr}.form-grid>div:empty{display:none}}
</style>

...
// =====================================================================
// 旧接口（已废弃，保留向后兼容，标注 deprecated）
// =====================================================================

/**
 * @deprecated 已迁移到 uploadMember / uploadPhoto。旧前端不再调用。
 */
...
/**
 * @deprecated 已迁移到 uploadLog / uploadHonor。旧前端不再调用。
 */
...
/**
 * @deprecated 已迁移到 getPublicTeamContent。旧前端不再调用。
 */
...
/**
 * @deprecated 已迁移到 deleteContent。旧前端不再调用。
 */
